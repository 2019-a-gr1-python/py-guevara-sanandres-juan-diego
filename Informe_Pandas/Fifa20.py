...
derby_players = fifa_all_players.loc[fifa_all_players.Club == 'Derby County']
derby_players.to_pickle("X://Documents//7mo//Python//FifaDataSet//players_derby.pickle")
derby_players = pd.read_pickle("X://Documents//7mo//Python//FifaDataSet//players_derby.pickle")


derby_first_team_no_GK = derby_players.query('Position != \'GK\'')

labels = np.array(['Pace','Shooting','Passing','Dribbling','Defending','Physic'])
stats = np.array([average_Stats(derby_first_team_no_GK,'Pace'),
                  average_Stats(derby_first_team_no_GK,'Shooting'),
                  average_Stats(derby_first_team_no_GK,'Passing'),
                  average_Stats(derby_first_team_no_GK,'Dribbling'),
                  average_Stats(derby_first_team_no_GK,'Defending'),
                  average_Stats(derby_first_team_no_GK,'Physic')])
...
plt.yticks([50,60,70,80], ["50","60","70","80"], color="black", size=10)
plt.ylim(40,90)
ax.plot(angles, stats, 'o-', linewidth=1, color="black")
ax.fill(angles, stats, alpha=0.25, color="black")
ax.set_thetagrids(angles * 180/np.pi, labels)
ax.set_title('Derby County valoración general')
ax.grid(True)
